...
{Ph.D. Candidate in Industrial Engineering, Optimization Track}{Sep 2019 -- Aug 2025 (Expected)}
...
{\normalfont \textit{Collaborator:}} Charles Dickens, \textbf{Changyu Gao}, Connor Pryor, Lise Getoor}
\begin{itemize}
...
\resumeItem{Adaptive Training for Transformer-based Models}{
  \begin{itemize}
    ...
    \item Achieved baseline performance with reduced computation, improving training efficiency
...
\resumeItem{Mining Inconsistency Issues using Semantic Search Model}{
  \begin{itemize}
    \item Developed semantic search system for detecting customer experience inconsistencies
    \item Enhanced search accuracy through fine-tuning approaches in TensorFlow
...
\begin{itemize}[leftmargin=*, label={}]
  ...
  % to the 6th annual Symposium on Foundations of Responsible Computing (FORC 2025).
