...
\resumeSubheading {Applied Scientist, Amazon}{Menlo Park, CA}
{Team: \textup{\textbf{Customer Services}}}{Aug 2025 -- Present}
\resumeItemListStart
\vspace{0.5em}
Developing automated root cause identification models for customer service issues to improve resolution efficiency and customer satisfaction.
...
\textbf{Human Languages}: English (fluent), Chinese (native), French (intermediate B2), Spanish (basic).
%-------------------------------------------
