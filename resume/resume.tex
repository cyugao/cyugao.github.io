...
\textit{PhD advisor:} \textup{\textbf{Prof. Stephen Wright}}
...
\resumeSubheadingTitleOnly{Neural Collapse and Loss Function Design \\ {\normalfont \textit{Collaborator:}} Dr. Yiqiao Zhong}
  \begin{itemize}
    \item Carried out experiments to the influence of various loss functions on the neural collapse phenomenon.
