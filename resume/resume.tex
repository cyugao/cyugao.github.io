...
{Designed a differentially private optimization algorithm for finding an approximate second-order stationary point with convergence guarantees. Applied the algorithm to the ERM problem with adaptive mini-batching.}
