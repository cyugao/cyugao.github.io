...
\newcommand{\resumeDualDegree}[5]{
  \vspace{-1pt}
\item
  \begin{tabular*}{0.97\textwidth}[t]{l@{\extracolsep{\fill}}r}
    \textbf{#1} & #2 \\
    \textit{\small#3} & \textit{\small #4} \\
    \textit{\small M.S., Computer Science} & \textit{\small Feb 2021 -- June 2024} \\
  \end{tabular*}\vspace{-5pt}
}
...
\begin{center}
  ...
  \begin{center}
    \begin{tabular}{c}
      \href{mailto:ustcgcy@gmail.com}{Email:ustcgcy@gmail.com} \\
...
{Ph.D., Industrial Engineering, Optimization Track}{Sep 2019 -- Aug 2025}
{}
\resumeSubheading
...
\resumeSubheading {Applied Scientist, Amazon}{Seattle, WA}
{Team: \textup{\textbf{Customer Services}}}{Aug 2025 -- Present}
\resumeItemListStart
% \vspace{0.5em}
\resumeItem{Infrastructure Modernization}{Owned the full migration of model pipelines. Established rigorous engineering standards by implementing integration testing and linting to ensure production stability.}
% \resumeItem{Developing automated root cause identification models for customer service issues to improve resolution efficiency and customer satisfaction.}{
...
\resumeItem{Adaptive Training for Transformer-based Models}{
  \begin{itemize}
    \item Developed \textit{adaptive training} algorithms and engineered gradient statistics analysis framework.
...
\resumeItem{Mining Inconsistency Issues using Semantic Search Model}{
  \begin{itemize}
    \item Implemented semantic search models for detecting customer experience inconsistencies.
    \item Enhanced search accuracy through \textit{fine-tuning} using TensorFlow.
...
\begin{itemize}
  ...
  \item Achieved first \textit{optimal-rate} results for robust stochastic convex optimization.
  \item Significantly improved sample complexity and relaxed strict requirements over existing algorithms, broadening their applicability.
\end{itemize}
...
\resumeSubHeadingListStart
\resumeSubItem{Languages}{Proficient: Python, SQL. Familiar: R, C, C++, Java, OCaml}
\resumeSubItem{Frameworks}{PyTorch, TensorFlow, JAX, Pandas, NumPy, SciPy}
\vspace{2pt}
\resumeSubItem{Interests}{Music, guitar, hiking, learning languages, reading, technology trends.}
\resumeSubItem{Human Languages}{Chinese (native), English (fluent), French (intermediate B2\textbackslash C1), Spanish (basic).}
\resumeSubHeadingListEnd
...
\begin{itemize}[leftmargin=*, label={}]
  ...
  \item
    \textbf{Changyu Gao}, Andrew Lowy, Xingyu Zhou, Stephen J. Wright. Private Heterogeneous Federated Learning Without a Trusted Server Revisited: Error-Optimal and Communication-Efficient Algorithms for Convex Losses, Proceedings of the 41st International Conference on Machine Learning (\textbf{ICML 2024}), Vienna, Austria. PMLR 235, 2024. [\textbf{Poster Award}, Midwest ML Symposium 2024]
